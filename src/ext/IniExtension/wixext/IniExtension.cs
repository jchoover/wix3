//-------------------------------------------------------------------------------------------------
// <copyright file="IniExtension.cs" company="Outercurve Foundation">
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// The Windows Installer XML Toolset Gaming Extension.
    /// </summary>
    public sealed class IniExtension : WixExtension
    {
        private IniCompiler compilerExtension;
        private IniDecompiler decompilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new IniCompiler();
                }
        ...
        public override DecompilerExtension DecompilerExtension
        {
            get
            {
                ...
                {
                    this.decompilerExtension = new IniDecompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "Microsoft.Tools.WindowsInstallerXml.Extensions.Data.ini.wixlib", tableDefinitions);
            }
